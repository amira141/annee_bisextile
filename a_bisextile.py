...
if A%4 == 0 and A%100 != 0 :  #Si l'année est un multiple de 4 et pas de 100, elle est bisextile
    print("L'année est bisextile.")
 
elif A%400 == 0: #Sinon si elle est un multiple de 400 elle est bisextile 
    print("L'année est bisextile")
